...
public class DialogService {
    ...
    public static void showLoadDialog(DialogMessage msg) {
        ...
        if (file != null) {
            Dispatcher.dispatch(new PersistMessage(PersistMessage.LOAD_RECORDTABLE, file, null));
        }
    }
    ...
    public static void showSaveAsDialog(DialogMessage msg) {
        ...
        if (file != null) {
            ...
            Dispatcher.dispatch(new PersistMessage(PersistMessage.SAVE_RECORDTABLE, file, null));
        }
    }
